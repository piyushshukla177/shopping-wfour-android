...
public class BillDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView tvName,tvDevery,tvBill_id, tvStatus, tvDate, tvPhone, tvAllAddress, tvPayMethod, tvPay, tvTransportFee,tvShippingMethod, delivery;
...
//        menuItem.setImage(GlobalFunctions.buildCounterDrawable(self,count, R.drawable.ic_cart));
//
//    }
