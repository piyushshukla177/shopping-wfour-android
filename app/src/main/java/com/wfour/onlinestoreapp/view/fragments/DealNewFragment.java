...
/**
 * Created by Suusoft on 12/2/2016.
 */

public class DealNewFragment extends com.wfour.onlinestoreapp.base.BaseFragment implements View.OnClickListener,
    ...
    private View.OnFocusChangeListener listenerFocusAddress = new View.OnFocusChangeListener() {
        ...
        public void onFocusChange(View view, boolean isFocus) {
            if (isFocus) {
                MapsUtil.getAutoCompletePlaces(DealNewFragment.this, RC_GET_ADDRESS);
            }
        }
    };


    public static DealNewFragment newInstance() {

        Bundle args = new Bundle();

        DealNewFragment fragment = new DealNewFragment();
    ...
    protected int getLayoutInflate() {
        return R.layout.fragment_deal_new;
    }
    ...
    protected void init() {
        ...
        categorieDatas.addAll(AppController.getInstance().getDealCategories());
...
//        categorieDatas.remove(7);
    ...
    protected void initView(View view) {
        ...
        edtDiscount = (EditText) view.findViewById(R.id.edt_discount);
        ...
        spnTimming = (Spinner) view.findViewById(R.id.spn_timming);
        spnCategory = (Spinner) view.findViewById(R.id.spn_title);
        tvTotal = (TextView) view.findViewById(R.id.tv_total);
        imgChoose = (ImageView) view.findViewById(R.id.img_chose_image);
        rbStandard = (RadioButton) view.findViewById(R.id.rb_standard);
        rbPremium = (RadioButton) view.findViewById(R.id.rb_premium);
        btnSubmit = (TextView) view.findViewById(R.id.tv_submit);
        imgDeal = (ImageView) view.findViewById(R.id.img_deal);
        chkRenew = (AppCompatCheckBox) view.findViewById(R.id.chk_renew);
        edtName = (EditText) view.findViewById(R.id.edt_name);
        tvCurency = (TextView) view.findViewById(R.id.tv_curency);
        tvPercent = (TextView) view.findViewById(R.id.tv_percent);
        btnAttachment = (TextView) view.findViewById(R.id.tv_attachment);
        lblFormProduct = (TextView) view.findViewById(R.id.lbl_form_product);
        llParentContent = (LinearLayout) view.findViewById(R.id.ll_parent_content);
        rltParentChoseImage = (RelativeLayout) view.findViewById(R.id.rlt_parent_chose_image);
        rltParentAttachFile = (RelativeLayout) view.findViewById(R.id.rlt_parent_attach_file);
        rltParentTitle = (RelativeLayout) view.findViewById(R.id.rlt_parent_title);
        rltParentAddress = (RelativeLayout) view.findViewById(R.id.rlt_parent_address);
        rltDiscount = (RelativeLayout) view.findViewById(R.id.rlt_parent_discount);
        rltParentTotal = (RelativeLayout) view.findViewById(R.id.rlt_parent_total);
        llParentDescription = (LinearLayout) view.findViewById(R.id.ll_parent_description);
        rltDuration = (RelativeLayout) view.findViewById(R.id.rlt_parent_duration);
        llParentTypeDeal = (LinearLayout) view.findViewById(R.id.rg_type_deal);
        vDividerAddress = view.findViewById(R.id.divider_address);
        vDividerDescription = view.findViewById(R.id.divider_description);
        vDividerDiscount = view.findViewById(R.id.divider_discount);
        vDividerDuration = view.findViewById(R.id.divider_duration);
        vDividerTypeDeal = view.findViewById(R.id.divider_type_deal);
        btnCancel = (TextView) view.findViewById(R.id.tv_cancel);
        lblFile = (TextView) view.findViewById(R.id.lbl_file);
        lblTitle = (TextView) view.findViewById(R.id.lbl_product);
        lblPrice = (TextViewRegular) view.findViewById(R.id.lbl_price);
        ...
        if (requestCode == RC_CAMERA_PERMISSION) {
            if (grantResults.length > 0) {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    AppUtil.captureImage(DealNewFragment.this, REQUEST_CODE_CAPTURE_IMAGE);
                } else {
...
//        showContentView(View.GONE);
    ...
    private void processNotDriverSelected() {
        GlobalFunctions.showConfirmationDialog(getActivity(), getString(R.string.you_are_not_driver), getString(R.string.yes), getString(R.string.no),
                true, new IConfirmation() {
                    ...
                    public void onNegative() {
                        resetSpinerCategory();
                        AppUtil.showToast(getActivity(), R.string.msg_register_driver);
                    }
                });
    }
        ...
        if (view == btnSubmit) {
            ...
            GlobalFunctions.showConfirmationDialog(self, getString(R.string.title_chose_image), getString(R.string.from_gallery), getString(R.string.from_camera),
                    true, new IConfirmation() {
                        @Override
                        public void onPositive() {
                            AppUtil.pickImage(DealNewFragment.this, REQUEST_CODE_SELECT_IMAGE);
                        }
            ...
            AppUtil.pickImage(DealNewFragment.this, REQUEST_CODE_SELECT_ATTACHMENT);
...
//                                spnCategory.setSelection(0);
            ...
            if (user.getProData() != null) {
                ...
                if (imgDeal.getDrawable() != null && imgDeal.getDrawable() instanceof BitmapDrawable) {
                    image = new DataPart("deal.png", AppUtil.getFileDataFromDrawable(getActivity(), imgDeal.getDrawable()), DataPart.TYPE_IMAGE);
                } else {
...
//                gotoChat(dealId, dealName);
    ...
    private void gotoChat(DealObj dealObj) {
        ...
        ChatActivityReskin2.start(getActivity(), null, recentChatObj);
        ...
        GlobalFunctions.showConfirmationDialog(getActivity(), getString(R.string.msg_not_enought_credits),
                getString(R.string.button_buy_credits), getString(R.string.button_promotions), true, new IConfirmation() {
                    ...
                    public void onPositive() {
                        ...
                        GlobalFunctions.startActivityForResult(DealNewFragment.this, BuyCreditsActivity.class, Args.RQ_BUY_CREDIT, bundle);
                    }
    ...
    private void showDialogBecomePro() {
        GlobalFunctions.showConfirmationDialog(getActivity(), getString(R.string.upgrade_pro_account),
                getString(R.string.become), getString(R.string.button_cancel), true, new IConfirmation() {
                    @Override
                    public void onPositive() {
                        Bundle bundle = new Bundle();
                        bundle.putBoolean(Args.IS_NEED_FINISH, true);
                        startActivityForResult(new Intent(getActivity(), BecomeAProActivity.class), REQUEST_CODE_BECOME_ONLY_PRO);
                    }
