...
public class GroupChannelListFragment extends Fragment {
    ...
    final static String TAG = GroupChannelListFragment.class.getSimpleName();
    ...
    public static GroupChannelListQuery mChannelListQuery;
    private SwipeRefreshLayout mSwipeRefresh;
    private ProductObj item;
    public static List<GroupChannel> arrayList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //((GroupChannelActivity) getActivity()).setActionBarTitle(getResources().getString(R.string.conversation));
        ((GroupChannelActivity) getActivity()).setActionBarTitle("Mensajen");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_go_home) {
            GlobalFunctions.startActivityWithoutAnimation(getActivity(), MainActivity.class);
            getActivity().finish();
        }
    ...
    private void refreshChannelList(int numChannels) {
        ...
        mChannelListQuery.next(new GroupChannelListQuery.GroupChannelListQueryResultHandler() {
            ...
            public void onResult(List<GroupChannel> list, SendBirdException e) {
                ...
                Log.e(TAG, "onResult: list" + list.size() );
                arrayList = list;
                Log.e(TAG, "onResult: arraylist"+ arrayList.size() );
            }
        });
